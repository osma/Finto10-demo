...
PROMPT = """
Your task is to translate terms from the General Finnish Ontology (YSO), a carefully curated thesaurus known for its precise and respectful terminology. These terms are used for academic and informational purposes and are presented in Finnish, Swedish, and English. Please maintain the list structure and translate each term into Estonian. Only return the list of translated terms, no explanations are needed.
...
Now translate the following thesaurus terms to Estonian:
